...
const Portfolio = () => {
  ...
  // Initialize Isotope and set filters
  useEffect(() => {
    if (typeof window !== "undefined" && Isotope) {
    ...
    >
      <div className="container">
        ...
        <div className="resume-box portfolio-content">
              ...
              <div className="col-sm-9 col-md-9 col-xl-10">
                <div className="rb-right">
                  ...
                  <p>
                    ...
                    <br />
                    • Affiliated with the National Organization for Development
                    of Exceptional Talents.
                    <br />• CGPA: 4/4 (19.23/20)
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-sm-9 col-md-9 col-xl-10">
                <div className="rb-right">
                  ...
                  <label>
                    Iran University of Science and Technology | Sep 2020 -
                    Present
                  </label>
                  <p>
                    • GPA of last 60 units: 3.75/4 (17.5/20) <br />
                    • CGPA: 3.32/4 (16.26/20)
                    <br />
                    • Related Courses: Natural Language Processing (4/4),
                    Computational Intelligence (4/4), Computer Vision (4/4),
                    Data Science (4/4), Software Engineering (4/4), Compiler
                    Design (4/4), Graph Theory and Algorithms (4/4), Security of
            ...
            <div className="row">
              <div className="col-sm-9 col-md-9 col-xl-10">
                <div className="rb-right">
                  ...
                  <p>
                    • Thesis Title: Diagnosis of Alzheimer&apos;s disease using
                    deep neural networks through three-dimensional brain images.
                    <br />
            ...
            <div className="row">
              <div className="col-sm-9 col-md-9 col-xl-10">
                <div className="rb-right">
                  ...
                  <p>
                    • Attending several workshops including Redux, RxJs,
                    Testing, Git, Debugging, etc
                    <br />
                    • Developing a whole Issue tracking project from scratch
                    using React, Typescript, Redux and RxJs
                    <br />
                    • Adopting top-notch technologies that we were taught during
                    the summer camp
                  </p>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-sm-9 col-md-9 col-xl-10">
                <div className="rb-right">
                  ...
                  <p>
                    • Teaching and mentoring students in Front-end development.
                    <br />
                    • Developing hands-on exercises and projects alongside a
                    team of seven to enhance students&apos; practical skills.
                    <br />
                    • Collaborating with the Faculty of Computer Engineering to
                    improve students&apos; knowledge through interactive lessons
                    and coding challenges.
                    <br />
                    • Supporting and guiding students through real-world
                    scenarios to prepare them for industry challenges.
                    <br />
                  </p>
                </div>
              </div>
          ...
          {/* Add additional Teaching Assistant entries here */}
        </div>
      </div>
    </section>
  );
