...
const Contact = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (
      ...
      emailjs
        .send(
          "service_6c2j64a", // service id
          "template_f9em1jh", // template id
          mailData,
          "WAqgvUM5Qk0zSYYhB" // public api
        )
        .then(
          (response) => {
            setError(false);
              ...
              <ul>
                <li className="media">
                  ...
                  <span className="media-body">
                    School of Computer Engineering, University of Science and Technology of Iran, University St., Hengam St., Resalat Square, Tehran, Iran. Postal Code: 16846-13114</span>
                </li>
                <li className="media">
